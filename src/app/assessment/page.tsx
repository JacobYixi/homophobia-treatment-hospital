...
function getResult(score: number) {
  ...
  if (percentage <= 10) {
    return {
      ...
      icon: CheckCircle2,
      desc: '您展现出了良好的包容性和平等意识，对性取向多样性有健康的认知。在当前社会环境下，保持这样的认知并不容易，您做得很好。',
      advice: '感谢您成为 ally。如果您愿意，可以把本测试转发给您身边那些"我只是传统"的朋友，让他们也来看看自己是否需要关注。',
    };
    ...
    return {
      ...
      icon: CheckCircle2,
      desc: '您可能存在一些轻微的恐同倾向，比如看到同性牵手会"本能"地移开视线。这种反应大多来自后天的环境影响，是可以被温和调整的。',
      advice: '建议多了解性取向相关的科学知识，多接触不同的观点。您现在的状态属于"早期关注阶段"，及时认知到这一点本身就是进步。本院的中药调理科很适合您当前的状况。',
    };
    ...
    return {
      ...
      icon: AlertTriangle,
      desc: '您的恐同倾向已经比较明显了。您可能经常在社交场合转发一些"传统价值观"的内容，或者在饭桌上不自觉地发表对性少数群体的负面评价。',
      advice: '建议认真思考一下：您的这些观点，有多少来自独立思考，有多少来自环境的灌输？改变偏见的第一步，是意识到自己可能有偏见。本院的行为约束科和强制劳动科可以为您提供系统化的帮助。',
    };
    ...
    return {
      ...
      icon: AlertTriangle,
      desc: '您的恐同已经到了需要重视的程度。您可能经常在网上与人争论，认为同性恋在"影响社会"，甚至尝试过阻止身边的性少数朋友"太张扬"。这种状态不仅影响他人，也在侵蚀您自己的社交关系。',
      advice: '建议您认真反思一下：您反对的究竟是同性恋本身，还是自己对"不同"的恐惧？当年别人试图"矫正"同性恋者，现在我们用同样的逻辑审视恐同——希望您能体会这种感受。本院的电刺激科和药物干预科拥有丰富的重度患者干预经验。',
    };
  } else {
    return {
      level: '极度恐同症',
      ...
      icon: XCircle,
      desc: '测试结果表明，您的恐同倾向已经非常严重。您对性少数群体的敌意达到了一个需要被正视和紧急干预的水平。这种状态对您自身的心理健康和社交关系都构成了严重威胁。',
      advice: '感到不适吗？这不过是一份问卷而已。当年同性恋者面对的可是真实的电击、监禁和社会排斥。如果您连文字都受不了，说明您确实需要正视自己的问题。本院建议立即预约重度综合干预套餐，由多学科专家团队联合制定康复方案。',
    };
  }
}
